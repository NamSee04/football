 ...
 */
@Generated
public class FootballLeagueManagerApplicationTests__TestContext001_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new FootballLeagueManagerApplicationTests__TestContext001_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new FootballLeagueManagerApplicationTests__TestContext001_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
